                        ...
                        <div class="card-body card-block">
                            ...
                            <form action="#" method="post" class="form-horizontal" id="fupForm">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-12"><input type="text" id="txtname" required="" name="txtname" onkeyup="fndemo()" placeholder="Full Name" class="form-control"><small class="form-text text-muted">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-6"><input type="email" id="txtemail" name="txtemail" placeholder="Enter Email-id" class="form-control" required pattern="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" title="Please Enter Valid Email Address" onkeyup="emailchecker()"><small class="help-block form-text">Email check in user table</small>
