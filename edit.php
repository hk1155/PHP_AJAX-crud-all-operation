...
include_once 'Connection.php';
    ...
    {
            mysqli_query($con,"UPDATE tbl_user set  name='" . $_POST['txtname'] . "', contact='" . $_POST['txtcontact'] . "',gender='".$_POST['gender']."',city='".$_POST['city']."' WHERE id='" . $_POST['hid'] . "'");
                                ...
                                <form action="#" method="post" class="form-horizontal" id="fmreg">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-12">
                                            <input type="text" id="txtname" id="txtname" name="txtname" onkeyup="fndemo()" value="<?php echo $row['name']; ?>" class="form-control"><small class="form-text text-muted"><div id="demoerr" style="color: blue"></div></small>
                                        </div>
