                            ...
                            <div class="card-body card-block">
                                ...
                                <form action="#" method="post" class="form-horizontal" id="fupForm">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 "><input type="text" id="txtname" required="" name="txtcompany"  placeholder="Company Name" class="form-control"><small class="form-text text-muted"><div id="demoerr" style="color: blue"></div></small></div>
